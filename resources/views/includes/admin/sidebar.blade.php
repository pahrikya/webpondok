...
<nav id="sidebar">
    ...
    <div class="sidebar-content">
        ...
        <div class="content-side content-side-full content-side-user px-10 align-parent">
            ...
            <div class="sidebar-mini-hidden-b text-center">
                <a class="img-link" href="javascript:void(0)">
                    <img class="img-avatar" src="{{asset('admin/assets/media/avatars/avatar11.jpg')}}" alt="">
                </a>
        ...
        <div class="content-side content-side-full">
            <ul class="nav-main">
                <li>
                    <a class="" href=""><i class="fa fa-hospital-o"></i><span class="sidebar-mini-hide">Overview</span></a>
                </li>
                ...
                <li>
                    <a href=""><i class="fa fa-wrench"></i><span class="sidebar-mini-hide">Settings</span></a>
                </li>
            </ul>
        </div>
        <!-- END Side Navigation -->
